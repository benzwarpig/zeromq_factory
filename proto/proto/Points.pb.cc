...
static ::_pb::Metadata file_level_metadata_Points_2eproto[1];
...
const uint32_t TableStruct_Points_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::LSLAM::Points, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ...
  ~0u,  // no _split_
  ~0u,  // no sizeof(Split)
  PROTOBUF_FIELD_OFFSET(::LSLAM::Points, _impl_.x_),
  PROTOBUF_FIELD_OFFSET(::LSLAM::Points, _impl_.y_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::LSLAM::Points)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::LSLAM::_Points_default_instance_._instance,
};

const char descriptor_table_protodef_Points_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014Points.proto\022\005LSLAM\"\036\n\006Points\022\t\n\001x\030\001 \001"
...
const ::_pbi::DescriptorTable descriptor_table_Points_2eproto = {
    false, false, 61, descriptor_table_protodef_Points_2eproto,
    "Points.proto",
    &descriptor_table_Points_2eproto_once, nullptr, 0, 1,
...
Points::Points(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:LSLAM.Points)
}
Points::Points(const Points& from)
  ...
  // @@protoc_insertion_point(copy_constructor:LSLAM.Points)
}
...
Points::~Points() {
  // @@protoc_insertion_point(destructor:LSLAM.Points)
...
void Points::Clear() {
// @@protoc_insertion_point(message_clear_start:LSLAM.Points)
...
uint8_t* Points::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:LSLAM.Points)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:LSLAM.Points)
  return target;
}

size_t Points::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:LSLAM.Points)
  size_t total_size = 0;
...
void Points::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:LSLAM.Points)
...
// @@protoc_insertion_point(class_specific_copy_from_start:LSLAM.Points)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void Points::InternalSwap(Points* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Points, _impl_.y_)
      + sizeof(Points::_impl_.y_)
      - PROTOBUF_FIELD_OFFSET(Points, _impl_.x_)>(
...
template<> PROTOBUF_NOINLINE ::LSLAM::Points*
Arena::CreateMaybeMessage< ::LSLAM::Points >(Arena* arena) {
  return Arena::CreateMessageInternal< ::LSLAM::Points >(arena);
}
